...
export function HeroSection() {
    return (
        <section className="landing-hero-section relative min-h-screen pt-24 pb-16 lg:pt-32 lg:pb-32 overflow-hidden flex items-center">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div
                    className="landing-hero-grid absolute inset-0 opacity-[0.02]"
                    style={{
            ...
            <div className="landing-hero-overlay absolute inset-0 z-0" />
...
function TerminalVisual() {
    ...
    const sampleTimestamp = '2026-03-29T15:20:02.468Z';
    ...
    return (
        <div className="relative w-full">
            ...
            {/* Main Window */}
            <div className="hero-terminal-window relative rounded-xl overflow-hidden">

                {/* Header Bar */}
                <div className="hero-terminal-header flex items-center justify-between px-4 py-3">
                    ...
                    <div className="hero-terminal-file-chip flex items-center gap-2 px-3 py-1 rounded-md text-[10px] sm:text-xs font-mono">
                    ...
                    <button
                        onClick={handleCopy}
                        className="hero-terminal-copy-btn p-1.5 rounded transition-colors"
                        title="Copy Code"
                    >
                ...
                {/* Code Content */}
                <div className="hero-terminal-body p-4 sm:p-6 overflow-x-auto custom-scrollbar">
                    <pre className="font-mono text-[11px] sm:text-xs md:text-[13px] leading-relaxed">
                        <code className="block min-w-max">
                            <div className="flex"><span className="hero-terminal-line-no w-6 select-none mr-2">1</span><span className="text-purple-400">{'{'}</span></div>
                            <div className="flex"><span className="hero-terminal-line-no w-6 select-none mr-2">2</span><span className="pl-4"><span className="text-sky-400">"event_id"</span>: <span className="text-emerald-400">"evt_84729104"</span>,</span></div>
                            <div className="flex"><span className="hero-terminal-line-no w-6 select-none mr-2">3</span><span className="pl-4"><span className="text-sky-400">"timestamp"</span>: <span className="text-amber-400">"{sampleTimestamp}"</span>,</span></div>
                            <div className="hero-terminal-risk-row flex -mx-4 sm:-mx-6 px-4 sm:px-6 border-l-2"><span className="hero-terminal-line-no w-6 select-none mr-2">4</span><span className="pl-4"><span className="text-sky-400">"risk_score"</span>: <span className="text-red-400 font-bold">0.98</span>,</span></div>
                            <div className="flex"><span className="hero-terminal-line-no w-6 select-none mr-2">5</span><span className="pl-4"><span className="text-sky-400">"signals"</span>: [</span></div>
                            <div className="flex"><span className="hero-terminal-line-no w-6 select-none mr-2">6</span><span className="pl-8"><span className="text-emerald-400">"velocity_check"</span>,</span></div>
                            <div className="flex"><span className="hero-terminal-line-no w-6 select-none mr-2">7</span><span className="pl-8"><span className="text-emerald-400">"suspicious_device"</span></span></div>
                            <div className="flex"><span className="hero-terminal-line-no w-6 select-none mr-2">8</span><span className="pl-4">],</span></div>
                            <div className="flex"><span className="hero-terminal-line-no w-6 select-none mr-2">9</span><span className="pl-4"><span className="text-sky-400">"action"</span>: <span className="text-red-400 font-bold">"BLOCK"</span></span></div>
                            <div className="flex"><span className="hero-terminal-line-no w-6 select-none mr-2">10</span><span className="text-purple-400">{'}'}</span></div>
                        </code>
                    </pre>
                </div>

                {/* Live Activity Footer */}
                <div className="hero-terminal-footer px-4 py-2.5 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="hero-terminal-connected text-[10px] font-medium uppercase tracking-wider">Connected</span>
                    </div>
                </div>
            </div>

            {/* Floating Context Card (Desktop only/Responsive) */}
            <div className="hero-terminal-alert absolute -right-4 md:-right-8 top-20 px-4 py-3 rounded-xl animate-fade-up hidden sm:block">
