    ...
    <section id="models" className="py-32 relative bg-[#030712] overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="responsive-table-wrap">
          <div className="scroll-reveal reveal-delay-2 border border-white/[0.05] rounded-lg overflow-hidden bg-white/[0.01] responsive-table">
            ...
            <div className="p-3 bg-[#0a0e17] border-t border-white/[0.05] font-mono text-[10px] text-slate-600 flex items-center gap-2 whitespace-nowrap">
