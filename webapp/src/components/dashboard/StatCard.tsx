...
export function StatCard({ label, value, change, positive, icon, className = '' }: StatCardProps) {
    return (
        <div className={`p-4 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.05] hover:border-white/[0.1] transition-all duration-200 group cursor-pointer ${className}`}>
