  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-1.5 mb-4">
        ...
        {flags.length > 3 && (
          <span className="px-2 py-0.5 text-[10px] font-semibold rounded-md bg-white/[0.04] border border-white/[0.08] text-slate-500">
            +{flags.length - 3}
          </span>
        )}
      </div>
      ...
      {/* Action */}
      <button
        className="w-full flex items-center justify-center gap-2 py-2 text-xs font-semibold text-slate-400 hover:text-white bg-white/[0.02] hover:bg-white/[0.06] rounded-lg border border-white/[0.04] hover:border-white/[0.1] transition-all duration-200"
        tabIndex={-1}
      >
